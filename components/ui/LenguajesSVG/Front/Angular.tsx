...
const Angular = ({ width = 64 }: { width?: string | number }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 242 256" width={width} height="auto">
        <g clipPath="url(#a)">
        ...
        <defs>
            <linearGradient id="c" x1="53.2" x2="245" y1="231.9" y2="140.7" gradientUnits="userSpaceOnUse">
                <stop stopColor="#E40035" /><stop offset=".2" stopColor="#F60A48" /><stop offset=".4" stopColor="#F20755" /><stop offset=".5" stopColor="#DC087D" /><stop offset=".7" stopColor="#9717E7" /><stop offset="1" stopColor="#6C00F5" />
            </linearGradient>
