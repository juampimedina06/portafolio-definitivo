  ...
  return (
    <section id='inicio' className='w-full h-[90vh] sm:flex gap-4 mt-4 overflow-hidden'>
      ...
      <div className='h-full flex gap-4 flex-col '>
        ...
        <div
          className='flex-1 bg-[#22D3EE] rounded-4xl p-8 flex flex-col justify-center gap-6 text-black'
        >
          <span className='text-[10px] font-bold uppercase tracking-[0.3em] opacity-40 text-black'>Tecnologías Principales</span>
          <div className='space-y-1'>
            <div className='flex items-baseline gap-2'>
              <span className='text-4xl font-black uppercase text-black'>React</span>
              <span className='text-sm font-bold opacity-30 text-black'>/ NEXT.JS</span>
            </div>
            <div className='flex items-baseline gap-2'>
              <span className='text-4xl font-black uppercase text-black'>Node.js</span>
              <span className='text-sm font-bold opacity-30 text-black'>/ TS</span>
            </div>
            <div className='flex items-baseline gap-2'>
              <span className='text-4xl font-black uppercase text-black'>PostgreSQL</span>
            </div>
          </div>
        </div>
      </div>
